classdef getMinTE_m1
    ...
    methods
        function obj = getMinTE_m1(timingParamsFile, mriSystemLabel, targetBval, pnsThresh, gmaxRange, smaxRange)
            ...
            switch mriSystemLabel
                ...
                case 'V'
                    obj.sys = mr.opts('MaxGrad', 40, 'GradUnit', 'mT/m', ...
                        'MaxSlew', 200, 'SlewUnit', 'T/m/s', ...
                        'rfRingdownTime', 30e-6, 'rfDeadtime', 100e-6, ...
                        'adcDeadTime', 10e-6, 'B0', 2.89);
        ...
        function [final_bval, final_seq, diffGrad_final, TE, valid_g, valid_s, pns_out_final] = compute(obj)
            ...
            while TE < maxTE
                ...
                [bval, tmp_seq, diffGrad, delayTE1_min, delayTE2_min, adjust_time] = pseq2.Bipolar.computeMaxBValue(delayTE1_min, delayTE2_min, gradRasterTime, obj.rf_90_duration + obj.nav_dur, obj.rf_90_rfCenterInclDelay, obj.rf_180_duration, obj.sys.maxGrad, obj.sys.maxSlew, obj.sys);
                ...
                elseif bval > obj.targetBval
                    ...
                    if ~isempty(valid_b)
                        [final_bval, final_seq, diffGrad_final, ~, ~, ~] = pseq2.Bipolar.computeMaxBValue(delayTE1_min, delayTE2_min, gradRasterTime, obj.rf_90_duration + obj.nav_dur, obj.rf_90_rfCenterInclDelay, obj.rf_180_duration, mr.convert(valid_g, 'mT/m', 'Hz/m'), mr.convert(valid_s, 'T/m/s', 'Hz/m/s'), obj.sys);
            ...
            [final_bval, final_seq, diffGrad_final, ~, ~, ~] = pseq2.Bipolar.computeMaxBValue(delayTE1_min, delayTE2_min, gradRasterTime, obj.rf_90_duration + obj.nav_dur, obj.rf_90_rfCenterInclDelay, obj.rf_180_duration, obj.sys.maxGrad, obj.sys.maxSlew, obj.sys);
            [pns_out_final, ~, ~, ~] = final_seq.calcPNS(obj.ascName, 1);
        end
        ...
        function [valid_b, valid_g, valid_s] = sweepHardwareConfigs(obj, delayTE1, delayTE2)
            ...
            parfor idx = 1:numComb
                ...
                g = g_vals(ig);
                s = s_vals(is);
                [tmp_bval, tmp_seq, diffGrad, ~, ~, adjust_time] = pseq2.Bipolar.computeMaxBValue(delayTE1, delayTE2, obj.sys.gradRasterTime, obj.rf_90_duration+ obj.nav_dur, obj.rf_90_rfCenterInclDelay, obj.rf_180_duration, g, s, obj.sys);
                if adjust_time == 0
