def DTI_recon(original_matrix, original_bvals, original_bvecs, tensor_fit = 'NLLS', atol = 0.01):
    """
    ########## Definition Inputs ##################################################################################################################
    ...
    for slc in range(slices):
        ...
        gtable   = gradient_table(bvals_slices_list[slc], bvecs_slices_list[slc], atol = atol)                                           # Create gradient table from b-values and b-vectors
